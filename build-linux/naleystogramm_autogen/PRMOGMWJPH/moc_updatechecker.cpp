...
template <> constexpr inline auto UpdateChecker::qt_create_metaobjectdata<qt_meta_tag_ZN13UpdateCheckerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(UpdateInfo)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
...
void UpdateChecker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->updateAvailable((*reinterpret_cast<std::add_pointer_t<UpdateInfo>>(_a[1]))); break;
        case 1: _t->noUpdateAvailable((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->checkFailed((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 3: _t->checkStarted(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (UpdateChecker::*)(UpdateInfo )>(_a, &UpdateChecker::updateAvailable, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (UpdateChecker::*)(const QString & )>(_a, &UpdateChecker::noUpdateAvailable, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (UpdateChecker::*)(const QString & )>(_a, &UpdateChecker::checkFailed, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (UpdateChecker::*)()>(_a, &UpdateChecker::checkStarted, 3))
            return;
    }
}
...
// SIGNAL 0
void UpdateChecker::updateAvailable(UpdateInfo _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void UpdateChecker::noUpdateAvailable(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1);
}

// SIGNAL 2
void UpdateChecker::checkFailed(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 2, nullptr, _t1);
}

// SIGNAL 3
void UpdateChecker::checkStarted()
{
