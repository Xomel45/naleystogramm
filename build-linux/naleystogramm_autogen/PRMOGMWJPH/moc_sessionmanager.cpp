...
void SessionManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SessionManager::*)()>(_a, &SessionManager::loaded, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SessionManager::*)()>(_a, &SessionManager::saved, 1))
            return;
    }
}
...
// SIGNAL 0
void SessionManager::loaded()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SessionManager::saved()
{
